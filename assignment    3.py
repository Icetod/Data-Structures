...
Github account: Icetod
Github link: https://.github.com/Icetod/Data-Structures
"""
...
#Check if car brand is in the CarsAvailable dictionary
if CarBrand in CarsAvailable:
    print("The", CarBrand, "is available.")
    print("The price for the", CarBrand, "is",CarsAvailable[CarBrand], "$")
else:
